...
elseif nargin == 5    
    ...
    switch property
        ...
        case 'confidence'     
            ...
            loglog(xg,Hg,'--b','LineWidth',1);    % Plots higher confidence interval
    
            h_legend=legend('Observed data','Generated data','lower confidence interval','higher confidence interval');
            set(h_legend,'Location','SouthWest')
            %num=num2str(fig);
            title(['Exceedence probability at ',strtrim(num),' station'],'FontSize',14);
            xlabel('Rainfall amount (mm)','FontSize',14);
            ylabel('Probability','FontSize',14);
